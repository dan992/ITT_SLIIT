                    ...
                    <tr>
                        ...
                        <td rowspan="0">
                            <div id='wrap'>
                                ...
                                <h2>Add your project new issue details...</h2>
                                <br />
                                <section>
                                    <form action="AddIssueController/addIssue" method="post">
                                        <fieldset>
                                            <input class="form-control" type="hidden" name="issueID" required='required' value="<?php echo $projID; ?>" ></input>
                                            <div class="list-item">
...
//  echo '<option >'.$priorty.'</option>';
                                            ...
                                            <div class="list-item">
                                                <label> <span>Due Date</span><br/><input class="form-control" id="inputField"
                                                                                         type="text" name="duedate" required='required' ></input></label>
                                                <div class='maketooltip help'>
                                                    <span>?</span>
                                                    <div class='content'>
                                                        <b></b>
                                            ...
                                            <div class="list-item">
                                                <label> <span>Affected Version </span><select
...
//echo '<option >'.$affectVir.'</option>';                    
                                            ...
                                            <div class="list-item">
                                                <label> <span>Original Estimate</span> <input class="form-control"
                                                                                              type="text" name="oEstimate" required='required'></input>
                                                </label>
                                                <div class='maketooltip help'>
                                                    <span>?</span>
                                                    <div class='content'>
                                            ...
                                            <div class="list-item">
                                                <label> <span>Remaining Estimate</span> <input class="form-control"
                                                                                               type="text" name="rEstimate" required='required' ></input>
                                                </label>
                                                <div class='maketooltip help'>
                                                    <span>?</span>
                                                    <div class='content'>
         ...
         <script>
            function cancel() {
                ...
                if (confirm("Cancel Adding issue...") == true) {
