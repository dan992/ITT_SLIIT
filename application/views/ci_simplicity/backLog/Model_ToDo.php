...
for ($i = 0; $i < sizeof($toDOarrayID); $i++) {
    ...
    echo '<div id="thanksToDo' . $toDOarrayID[$i] . '"><p><a style="color: #000"  href="' . site_url('BackLogController/moveToUpdate?issueid=' . $toDOarrayID[$i]) . '" >Edit</a>
                 <a>||</a>
                    <a style="color: #000" href="#" onclick="deleteIssueFunction('.$toDOarrayID[$i].')" >Delete</a></p></div>
