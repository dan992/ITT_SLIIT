...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"/>
   ...
   <link href="<?php echo base_url(); ?>assets/themes/default/css/style.css" rel="stylesheet"  media="screen" />
    <link href="<?php echo base_url(); ?>assets/themes/default/css/datepicker.min.css" rel="stylesheet"/>
    <link href="<?php echo base_url(); ?>assets/themes/default/css/jsDatePick_ltr.min.css" rel="stylesheet" media="all"/>
    
<link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>assets/themes/default/css/jsDatePick_ltr.min.css" />
<script type="text/javascript" src="<?php echo base_url(); ?>assets/themes/default/js/jsDatePick.min.1.3.js"></script>
  ...
  <script type="text/javascript" charset="utf-8" src="<?php echo base_url(); ?>assets/themes/default/js/modals.js"></script>
  <script type="text/javascript" charset="utf-8" src="<?php echo base_url(); ?>assets/themes/default/js/bootstrap-datepicker.js"></script>  
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
      ...
      <form class="navbar-form navbar-left" role="search">
          <img src=<?php echo $this->User->getAvatar(); ?> alt="..." class="img-thumbnail" style="height:50px">
      </form>
           <li><a href="#" style="text-decoration:none;margin-top: 8px"><?php if($this->session->userdata("loggedIn"))echo $this->session->userdata("username"); ?></a></li>
           <?php 
           if($this->session->userdata("loggedIn"))
           {
               //$this->session->set_userdata("loggedIn",FALSE);
               echo "<li><a href=".base_url().'index.php/LoginController'." style='text-decoration:none;margin-top: 8px'>Log out</a></li>"; 
           }   
           else
               echo "<li><a href=".base_url().'index.php/signInController'." style='text-decoration:none;margin-top: 8px'>Sign Up</a></li>";
           ?>
    ...
    <div id="sidebar-wrapper" >
            ...
            <ul class="sidebar-nav"  >
                ...
                <br/>
                <li><a href="<?php echo base_url().'example"'?>  style="font-size: 17px;padding-left:50px" >New Project</a>
                </li>
                 <br/>
                 <li><a href="<?php echo base_url().'index.php/AllTeamsController"'?>  style="font-size: 17px;padding-left:50px">Teams</a>
                </li>
                   <br/>
                <li><a href="<?php echo base_url().'index.php/BackLogController?issueIdR="' ?> style="font-size: 17px;padding-left:50px">Back Log</a>
                </li>
                      <br/>
                <li><a href="<?php echo base_url().'index.php/SprintController"'?>  style="font-size: 17px;padding-left:50px">New Sprint</a>
                </li>
                  <br/>                 
                <li><a href="<?php echo base_url().'index.php/AllVersionController"'?>  style="font-size: 17px;padding-left:50px">View Versions</a>
                </li>
                   <br/>
